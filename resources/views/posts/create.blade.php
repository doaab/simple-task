                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form"  action="{{route('post.store')}}" method="post" enctype="multipart/form-data" autocomplete="on">
                                            {{ csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <label class="checkbox-inline icheckbox">
                                                        <input type="checkbox" name="category[]" id="inlineCheckbox1" value="{{$cat->id}}"> {{$cat->category}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    @foreach($tags as $tag)
                                                    <label class="checkbox-inline icheckbox">
                                                        <input type="checkbox" name="tags[]" id="inlineCheckbox1" value="{{$tag->id}}">
                                                        {{$tag->tag}}
